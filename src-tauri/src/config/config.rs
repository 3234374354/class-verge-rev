use super::{Draft, IclassesTemp, IProfiles, IRuntime, IVerge};
use crate::{
    config::PrfItem,
...
pub const RUNTIME_CONFIG: &str = "classes-verge.yaml";
pub const CHECK_CONFIG: &str = "classes-verge-check.yaml";

pub struct Config {
    classes_config: Draft<IclassesTemp>,
...
impl Config {
    pub fn global() -> &'static Config {
        ...
        CONFIG.get_or_init(|| Config {
            classes_config: Draft::from(IclassesTemp::new()),
    ...
    pub fn classes() -> Draft<IclassesTemp> {
        Self::global().classes_config.clone()
    }
    ...
    pub fn generate_file(typ: ConfigType) -> Result<PathBuf> {
        ...
        help::save_yaml(&path, &config, Some("# Generated by classes Verge"))?;
        Ok(path)
    }
